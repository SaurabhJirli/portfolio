...
export default function ProjectCard2({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl border border-border-subtle bg-surface-inset p-1.5 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:border-border-strong">
        {/* Inner core */}
